  ...
  */
  load:function(view, callback){
    ...
    this.collection.once("value", webix.bind(function(pack){
      ...
      var result = [];
      // if (isCollection){
      //   var result = {'config':{'columns' : []}, 'data':[]};
      //   //preserve data order
      //   pack.forEach(function(root){
      //
      //     if (root.key == 'config') {
      //       result[root.key]['columns'] = root.child('columns').val();
      //     } else {
      //
      ...
      //         record.id = child.key;
      //         if (root.key == 'config') {
      //           result[root.key]['columns'].push(record);
      //         } else {
      //           result[root.key].push(record);
      //         }
      //       });
      //     }
      //
