...
export default class DepartmentView extends JetView{
      ...
      cols:[
        {
          rows: [
...

            {
              ...
              cols: [
                ...
                { "label": "", "view": "search-close", "width": 300,  "align" :"right", localId: 'form-search'  },
                {
                  ...
                  width: 30,
                  click: function() {
                    webix.fullscreen.set("salary-type-table");
                  }
                },
              ]
            },
            ...
            {
              view: "datatable",
              localId: "salary-type-table",
              urlEdit: 'employee-salary-type',
              //autoConfig: true,
              ...
              url: this.app.config.apiRest.getUrl('get',"accounting/employee-salary-types", {'sort':'name'}),//"api->accounting/contragents",
              save: "api->accounting/employee-salary-types",
              // scheme: {
  ...
  init(view){
    ...
    let table = this.$$("salary-type-table");
    ...
    form.attachEvent("onChange", function(obj){
      ...
      webix.ajax().get( scope.app.config.apiRest.getUrl('get','accounting/employee-salary-types'), objFilter).then(function(data) {
        table.parse(data);
      });
  ...
  doAddClick() {
    this.$$('salary-type-table').unselect();
    this.cashEdit.showForm(this.$$('salary-type-table'));
  }
