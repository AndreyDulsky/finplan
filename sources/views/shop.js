...
export default class ShopView extends JetView{
	config(){
    ...
    menu['data'].push({ value:"Открытые отчеты1", id:"store.product", icon:"mdi mdi-folder-open" })
    ...
    this.use(plugins.Menu, "shop:menu");
		let scope = this;
