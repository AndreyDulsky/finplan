          ...
          rows: [
            ...
            },
            {
              ...
              columns:[
                ...
                { id:"param_link", header:[ "Ссылка", { content:"selectFilter" }, "" ], width: 90, sort: "string" },
                { id:"description", header:[ "Описание", { content:"selectFilter" }, "" ], width: 70, sort: "string" },
                { id:"param_description", header:[ "Полное описание", { content:"selectFilter" }, "" ], width: 70, sort: "string" },
