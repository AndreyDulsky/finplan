...
export default class CalculationFieldView extends JetView{
  config(){
    let scope = this;
    return {
      localId: "layout",
      ...
      cols:[
        {
          rows: [
...

            {
              ...
              cols: [
                ...
                { "label": "", "view": "search-close", "width": 300,  "align" :"right", localId: 'form-search'  },
                {
                  ...
                  width: 30,
                  click: function() {
                    webix.fullscreen.set(this.$scope.$$("calculation-field-table"));
                  }
                },
              ]
            },
            ...
            {
              view: "treetable",
              localId: "calculation-field-table",
              urlEdit: 'calculation-field',
              //autoConfig: true,
              ...
              columns:[
                ...
                { id:"field_name", header:"Свойство", width: 150},
              ...
              url: this.app.config.apiRest.getUrl('get',"accounting/calculation-fields", {'sort':'name'}),//"api->accounting/contragents",
              save: "api->accounting/calculation-fields",
  ...
  init(view){
    ...
    let table = this.$$("calculation-field-table");
    ...
    form.attachEvent("onChange", function(obj){
      ...
      webix.ajax().get( scope.app.config.apiRest.getUrl('get','accounting/calculation-fields', {'sort':'name'}), objFilter).then(function(data) {
        table.parse(data);
        table.openAll();
      });
  ...
  doAddClick() {
    this.$$('calculation-field-table').unselect();
    this.cashEdit.showForm(this.$$('calculation-field-table'));
  }
