...
export default class ProductBedSizeDirectoryView extends JetView{
      ...
      cols:[
        {
          rows: [
...

            {
              ...
              cols: [
                ...
                { "label": "", "view": "search-close", "width": 300,  "align" :"right", localId: 'form-search'  },
                {
                  ...
                  width: 30,
                  click: function() {
                    webix.fullscreen.set(this.$scope.$$("product-bed-type-table"));
                  }
                },
              ]
            },
            ...
            {
              view: "treetable",
              localId: "product-bed-type-table",
              urlEdit: 'product-bed-type',
              //autoConfig: true,
              ...
              url: this.app.config.apiRest.getUrl('get',"accounting/product-bed-types", {'sort':'name'}),//"api->accounting/contragents",
              save: "api->accounting/product-bed-types",
  ...
  init(view){
    ...
    let table = this.$$("product-bed-type-table");
    ...
    form.attachEvent("onChange", function(obj){
      ...
      webix.ajax().get( scope.app.config.apiRest.getUrl('get','accounting/product-bed-types', {'sort':'name'}), objFilter).then(function(data) {
        table.parse(data);
        table.openAll();
      });
  ...
  doAddClick() {
    this.$$('product-bed-type-table').unselect();
    this.cashEdit.showForm(this.$$('product-bed-type-table'));
  }
