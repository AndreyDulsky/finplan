...
export default class DirectoryView extends JetView{
  config(){
    let scope = this;
    return {
      localId: "layout",
      ...
      cols:[
        {
          rows: [
...

            {
              ...
              cols: [
                ...
                { "label": "", "view": "search-close", "width": 300,  "align" :"right", localId: 'form-search'  },
                {
                  ...
                  width: 30,
                  click: function() {
                    webix.fullscreen.set(this.$scope.$$("directory-type-table"));
                  }
                },
              ]
            },
            ...
            {
              view: "treetable",
              localId: "directory-type-table",
              urlEdit: 'directory-type',
              //autoConfig: true,
              ...
              url: this.app.config.apiRest.getUrl('get',"accounting/directory-types", {'sort':'name'}),//"api->accounting/contragents",
              save: "api->accounting/directory-types",
  ...
  init(view){
    ...
    let table = this.$$("directory-type-table");
    ...
    form.attachEvent("onChange", function(obj){
      ...
      webix.ajax().get( scope.app.config.apiRest.getUrl('get','accounting/directory-types', {'sort':'name'}), objFilter).then(function(data) {
        table.parse(data);
        table.openAll();
      });
  ...
  doAddClick() {
    this.$$('directory-type-table').unselect();
    this.cashEdit.showForm(this.$$('directory-type-table'));
  }
