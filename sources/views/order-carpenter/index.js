...
export default class OrderCarPenterView extends JetView{
  ...
  config(){
    ...
    return {
      rows:[
        {
          cols:[
            {"view": "label", width: 200, height:30, template: "План Столярка", css: { 'font-size':'17px', 'padding': '10px 0px 10px 15px', 'font-weight': 600}},
            {
        ...
        /*wjet::Settings*/
        {
          ...
          columns:[
...

            {
              ...
              template:function(obj, common){
                ...
                if (obj.$level == 1) return common.treetable(obj, common) + formatDate(obj.date_carpenter);
                return obj.A;
              },
            ...
            { id:"AG", header:[ "Коэф. ст. план", { content:"textFilter" }, { content:"totalColumn" } ],
              width:125,
              "css": {"text-align": "right",  "font-weight": 500}, batch:1,
            },
            ...
            {
              id:"date_carpenter",
              header:[ "Дата Ст.", { content:"selectFilter" }, "" ],
              width:100,
              editor:"date",
              //format:webix.Date.dateToStr("%d.%m.%y"),
              batch:1,
              hidden: false,
              template: function(obj) {
                return formatDate(parserDate(obj.date_carpenter));
              }
            },

            { id:"BA", header:[ "Статус ст.", { content:"selectFilter" }, "" ], width:100, batch:1, editor:"text",
            ...
            { id:"coef_carpenter", header:[ "Коэф. Ст. гот.", { content:"textFilter" }, { content:"totalColumn" } ],
              width:120,
          ...
          scheme:{
            ...
            //   //row:"A"
            // },
            $sort:{ by:"date_carpenter", dir:"asc", as: "date" },
  ...
  init(view) {
    ...
    let tableUrl = this.app.config.apiRest.getUrl('get',"accounting/orders", {
      "per-page": "500",
      sort: '[{"property":"date_carpenter","direction":"ASC"}, {"property":"index","direction":"ASC"}]',
