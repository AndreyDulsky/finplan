...
export default class DirectoryView extends JetView{
...

            {
              ...
              cols: [
                ...
                { "label": "", "view": "search-close", "width": 300,  "align" :"right", localId: 'form-search'  },
                {
                  ...
                  width: 30,
                  click: function() {
                    webix.fullscreen.set(this.$scope.$$("directory-table"));
                  }
                },
              ]
            },
  ...
  init(view){
    ...
    let table = this.$$("directory-table");
  ...
  doAddClick() {
    this.$$('directory-table').unselect();
    this.cashEdit.showForm(this.$$('directory-table'));
  }
